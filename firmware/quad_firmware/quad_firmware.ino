...
void loop() {
  ...
  if(abs(error_pitch) < 5) error_pitch = 0.0;
  if(abs(error_roll) < 5) error_roll = 0.0;
...
void spinMotors(int throttle, int control_output_roll, int control_output_pitch, int control_output_yaw) {
  if(abs(control_output_roll) > 255) control_output_roll = 0;
  if(abs(control_output_pitch) > 255) control_output_pitch = 0;
  if(abs(control_output_yaw) > 255) control_output_yaw = 0;
